...
const Footer = () => {
    return (
        <div>
            <footer aria-label="Site Footer"  className="bg-[#7e8ffe18] mt-12">
  <div
    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div className="text-teal-600">
          <h1 className='font-bold text-2xl'>jobHunt</h1>
        </div>

        <p className="max-w-xs mt-4 text-gray-500">
        Welcome to our job site! We are a platform that connects talented job seekers with leading employers from various industries. 
        </p>
