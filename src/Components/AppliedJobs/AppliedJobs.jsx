...
const AppliedJobs = () => {
    ...
    console.log(cl)
    const filterOnsite =() =>{
        const filteredDataOnsite = storedData.filter(data => data.jobType === 'On-site')
        setStoredDataf(filteredDataOnsite)

    }
    const filterRemote =() =>{
        const filteredDataRemote = storedData.filter(data => data.jobType === 'Remote')
        setStoredDataf(filteredDataRemote)
    }
    console.log(storedDataf)
    ...
    return (
        <div>
          ...
          <div className='bg-[#7e8ffe18] relative'>
            ...
            <div className='flex-row-reverse my-2'>
                    <h1 className='text-2xl font-bold text-[#7E90FE]'>Filter:</h1>
                    <div onClick={()=>check()}>
                    <button onClick={()=>filterOnsite()} className='border hover:bg-[#7e8ffe18] hover:text-black border-indigo-500 px-4 py-1 rounded mr-4 text-[#7E90FE] font-semibold'>On-site</button>
                    <button onClick={()=>filterRemote()} className='border hover:bg-[#7e8ffe18] hover:text-black border-indigo-500 px-4 py-1 rounded text-[#7E90FE] font-semibold'>Remote</button>
                    </div>
                </div>
                <div className=''>
                    {
